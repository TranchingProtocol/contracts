...
contract L1ERC20Bridge is IL1Bridge, IL1BridgeLegacy, AllowListed, ReentrancyGuard {
    ...
    IMicro internal immutable micro;

    /// @dev A mapping L2 batch number => message number => flag
    /// @dev Used to indicate that micro L2 -> L1 message was already processed
    ...
    constructor(IMicro _micro, IAllowList _allowList) reentrancyGuardInitializer {
        micro = _micro;
    ...
    function deposit(
        ...
        l2TxHash = micro.requestL2Transaction{value: msg.value}(
            l2Bridge,
            0, // L2 msg.value
            l2TxCalldata,
            _l2TxGasLimit,
    ...
    function claimFailedDeposit(
        ...
        bool proofValid = micro.proveL1ToL2TransactionStatus(
            _l2TxHash,
            _l2BatchNumber,
            _l2MessageIndex,
            _l2TxNumberInBatch,
