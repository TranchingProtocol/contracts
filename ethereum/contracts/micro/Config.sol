...
uint256 constant MAX_REPEATED_STORAGE_CHANGES_COMMITMENT_BYTES = 4 + REPEATED_STORAGE_CHANGE_SERIALIZE_SIZE * 4765;

// TODO: change constant to the real root hash of empty Merkle tree (SMA-184)
bytes32 constant DEFAULT_L2_LOGS_TREE_ROOT_HASH = bytes32(0);

/// @dev Denotes the type of the micro transaction that came from L1.
uint256 constant PRIORITY_OPERATION_L2_TX_TYPE = 255;

/// @dev Denotes the type of the micro transaction that is used for system upgrades.
...
/// @dev The L2 gas limit for requesting L1 -> L2 transaction of deploying L2 contract instance.
/// @dev It is big enough to deploy any contract, so we can use the same value for all contracts.
/// NOTE: this constant will be accurately calculated in the future.
uint256 constant DEPLOY_L2_CONTRACT_TX_GAS_LIMIT = $(DEPLOY_L2_CONTRACT_TX_GAS_LIMIT);
